...
import com.evgeniy.entity.Photo;
import com.evgeniy.entity.Student;
import com.evgeniy.entity.User;
import com.evgeniy.repository.PhotoRepository;
...
public class StudentController {
    ...
    public String getStudent(Model model) {
        ...
        Iterable<Photo> photo = photoRepository.findAll();
    ...
    @PostMapping("/student")
    public String postStudent(@RequestParam(value = "url") String url,
