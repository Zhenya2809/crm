...
public class Psychologist implements Command {
        ...
        switch (localState) {
            ...
            case "chose_data_to_appointment":
                if (inputMessage.equals(today.toString())) {
                    ...
                    List<String> strings = executionContext.freeTimeToAppointmentForDay(today,2L);
            ...
            case "pickTime":
                ...
                executionContext.createAppointmentToDoctor(today,inputMessage,"2");
                executionContext.setLocalState(null);
                executionContext.setGlobalState(null);
                break;
            case "todayPlusDay":
                executionContext.createAppointmentToDoctor(today.plusDays(1),inputMessage,"2");
                executionContext.setLocalState(null);
                executionContext.setGlobalState(null);
                break;
            case "todayPlus2Day":
                executionContext.createAppointmentToDoctor(today.plusDays(2),inputMessage,"2");
                executionContext.setLocalState(null);
                executionContext.setGlobalState(null);
                break;
            case "todayPlus3Day":
                executionContext.createAppointmentToDoctor(today.plusDays(3),inputMessage,"2");
                executionContext.setLocalState(null);
                executionContext.setGlobalState(null);
                break;
            case "todayPlus4Day":
                executionContext.createAppointmentToDoctor(today.plusDays(4),inputMessage,"2");
                executionContext.setLocalState(null);
                executionContext.setGlobalState(null);
                break;
        }
    ...
    public boolean shouldRunOnText(String text) {
        return text.equals("Психолог");
    }

    @Override
    public DataUserTg.botstate getGlobalState() {
        return DataUserTg.botstate.PSYCHOLOGIST;
    }
}