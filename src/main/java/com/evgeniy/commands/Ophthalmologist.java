...
@Component
public class Ophthalmologist implements Command {
        ...
        switch (localState) {
            ...
            case "chose_data_to_appointment":
                if (inputMessage.equals(today.toString())) {
                    ...
                    List<String> strings = executionContext.freeTimeToAppointmentForDay(today,4L);
            ...
            case "today":
                ...
                executionContext.createAppointmentToDoctor(today,inputMessage,"4");
                executionContext.setLocalState(null);
                executionContext.setGlobalState(null);
                break;
            case "todayPlusDay":
                executionContext.createAppointmentToDoctor(today.plusDays(1),inputMessage,"4");
                executionContext.setLocalState(null);
                executionContext.setGlobalState(null);
                break;
            case "todayPlus2Day":
                executionContext.createAppointmentToDoctor(today.plusDays(2),inputMessage,"4");
                executionContext.setLocalState(null);
                executionContext.setGlobalState(null);
                break;
            case "todayPlus3Day":
                executionContext.createAppointmentToDoctor(today.plusDays(3),inputMessage,"4");
                executionContext.setLocalState(null);
                executionContext.setGlobalState(null);
                break;
            case "todayPlus4Day":
                executionContext.createAppointmentToDoctor(today.plusDays(4),inputMessage,"4");
                executionContext.setLocalState(null);
                executionContext.setGlobalState(null);
                break;
        }
    ...
    public boolean shouldRunOnText(String text) {
        return text.equals("Офтальмолог");
    }

    @Override
    public DataUserTg.botstate getGlobalState() {
        return DataUserTg.botstate.OPHTHALMOLOGIST;
    }
}